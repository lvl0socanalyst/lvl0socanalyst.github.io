---
layout: post
title:  "Dismantling a Telegram Bot with InfoStealer Logs"
...
![alt text](/images/secure_document.PNG) 
...
Interesting! Looks like a paid service ran by Cyborg Solider? The ``109.248.151.138`` testing stops after the message from Cyborg Solider. Perhaps that is the IP of the person who runs the bot and sells the logs to someone else?

![alt text](/images/anotherone.PNG)

![alt text](/images/more.PNG)

Okay, I'm pretty confident it's MaaS now. 
...
I assume these are phishing themes offered by the MaaS offerers?
...
The format these IPs are using to test the bots is a numeric password such as '1111999231' or '7777775'. Furthermore, multiple tests come within 5 - 10 minutes. Because of this pattern, I can confidently attribute these to the MaaS provider checking the bots functionality.
...
1. The MaaS developer is testing the phishing page on his mobile device.
2. The MaaS developer's VPS connection dropped and was hotspotting.
...
I am super duper confident, this confirms the MaaS provider is from South Africa.
...
Therefore, I can say we a high degree of certainty the MaaS provider is from Cape Town.
