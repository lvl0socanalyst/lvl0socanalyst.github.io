...
Leaving this space to dig into the IP 

![Stage 5](/images/PE_studio_result.PNG)

So, this is our file. A healthy 4.5mbs of bits and bytes. Here is the hash ``3707fb795cd31deea7c4518a420a1a29`` 
- Unrecognisable. This is darn epic. 
...
There is one mega func called ``function rlKOKXNEZUxydHf`` that defines a lot of variables. 
...
![Stage 13](/images/base64_strings)
...
![Stage 17](/images/writing_payload_to_bin.PNG)
...
![Stage 18](/images/PE_studio_details.PNG)
