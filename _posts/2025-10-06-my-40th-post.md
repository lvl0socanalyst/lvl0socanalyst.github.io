---
layout: single
title:  Common JWT Attack Vectors
...
Quite a relevant attack. This attack is possible if the developer who has set up the configuration uses a generic signing key. Thus, allow it to be bruteforced from a word list. Furthermore, RS256 is being used.
