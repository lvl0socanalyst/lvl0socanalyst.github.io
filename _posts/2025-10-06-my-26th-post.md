...
IP, B66, URL and email search looks dry.
...
2/3 light up. Hell yeah. I've found the network IOCs. Lets try and see who owns these!
...
Naming convention is somehwat similar. My guess is these are C2 domains as well.

Shodan shows that RDP port is open. No vulns. Pretty tight setup Windows Server 2022. 
...
In summary this is what we currently know. An indian consulting company website was popped. As a result a Clickfix Prompt from the IUAM Cickfix Kit was deployed on there site. This prompt deployed NetSupport RAT. 

We have the following artefacts to work off:
...
- Little obfuscation and no encryption in dropper
