---
layout: single
title:  "NetSupport RAT Delivered Through Clickfix"
date:   2025-09-09 21:00:00 +1000
categories: malware analysiss
---
...
The clickfix prompt pasted into windows run used ``Invoke-WebRequest`` to download a .wav file from an IP, save it as a .ps1 one and then run it.
