---
layout: post
title:  "Red Direction C2 Browser Extension Campaign"
...
The domain resolves to two IPs. Both behind Cloudflare (classic) so little information we can get there.

![nslookup](/images/nslookup.PNG)

I've hit the point of extreme obfuscation. I don't have the brain for it right now. I will not that Browser Extension code is all visible. Therefore, obfuscating heavily is quite common to prevent people from copying your code!

Because I'm skill challenged tonight I'm going to whack it in a VM and see what activity we can capture.
