...
The domain resolves to two IPs. Both behind Cloudflare so little information we can get there. Likely hosted on a big old Cloudflare web server that hosts a bunch of other domains as well.
